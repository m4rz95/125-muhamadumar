      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5 lg:gap-6">
        <div class="card bg-gradient-to-r from-blue-500 to-indigo-600 px-5 pb-5">
          ...
          <div class="absolute bottom-0 right-0 overflow-hidden rounded-lg">
            <img class="w-24 translate-x-1/4 translate-y-1/4 opacity-50" src="{{ 'assets/images/illustrations/the-dollar.svg' }}" alt="image">
          </div>
        </div>
        ...
        <div class="mt-3 space-y-3.5">
          <div class="card p-3">
            <div class="flex items-center space-x-3">
              <img class="size-10 rounded-lg object-cover object-center" src="{{ 'assets/images/illustrations/lms-ui.svg' }}" alt="image">
              <div class="flex-1">
          ...
          <div class="card p-3">
            <div class="flex items-center space-x-3">
              <img class="size-10 rounded-lg object-cover object-center" src="{{ 'assets/images/illustrations/store-ui.svg' }}" alt="image">
              <div class="flex-1">
                <div class="flex justify-between">
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    Store Dashboard
          ...
          <div class="card p-3">
            <div class="flex items-center space-x-3">
              <img class="size-10 rounded-lg object-cover object-center" src="{{ 'assets/images/illustrations/chat-ui.svg' }}" alt="image">
              <div class="flex-1">
                <div class="flex justify-between">
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    Chat Mobile App
          ...
          <div class="card p-3">
            <div class="flex items-center space-x-3">
              <img class="size-10 rounded-lg object-cover object-center" src="{{'assets/images/illustrations/nft.svg'}}" alt="image">
              <div class="flex-1">
                <div class="flex justify-between">
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    NFT Marketplace App
          ...
          <div class="space-y-3.5" x-data="{expandedItem:'item-1'}">
            <div x-data="accordionItem('item-1')">
              <div class="flex items-center justify-between">
                ...
                <button @click="expanded = !expanded" class="btn size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div x-data="accordionItem('item-2')">
              <div class="flex items-center justify-between">
                <div class="flex space-x-4">
                  <div class="avatar size-10">
                    <img class="rounded-full" src="{{ 'assets/images/avatar/avatar-6.jpg' }}" alt="avatar">
                  </div>
                  <div>
                    <h3 class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                      Alfredo Elliott
            ...
            <div x-data="accordionItem('item-4')">
              <div class="flex items-center justify-between">
                <div class="flex space-x-4">
                  <div class="avatar size-10">
                    <img class="rounded-full" src="{{ 'assets/images/avatar/avatar-3.jpg' }}" alt="avatar">
                  </div>
                  <div>
                    <h3 class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                      Henry Curtis
        ...
        <div class="card px-4 pb-4 sm:px-5">
          ...
          <div class="space-y-3.5">
            ...
            <div class="flex cursor-pointer items-center justify-between">
              <div class="flex items-center space-x-3.5">
                <div class="avatar">
                  <img class="rounded-full" src="{{ 'assets/images/avatar/avatar-5.jpg' }}" alt="avatar">
                </div>
                <div>
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    Henry Curtis
            ...
            <div class="flex cursor-pointer items-center justify-between">
              <div class="flex items-center space-x-3.5">
                <div class="avatar">
                  <img class="rounded-full" src="{{ 'assets/images/avatar/avatar-18.jpg' }}" alt="avatar">
                </div>
                <div>
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    Derrick Simmons
            ...
            <div class="flex cursor-pointer items-center justify-between">
              <div class="flex items-center space-x-3.5">
                <div class="avatar">
                  <img class="rounded-full" src="{{ 'assets/images/avatar/avatar-7.jpg' }}" alt="avatar">
                </div>
                <div>
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    Kartina West
            ...
            <div class="flex cursor-pointer items-center justify-between">
              <div class="flex items-center space-x-3.5">
                <div class="avatar">
                  <img class="rounded-full" src="{{ 'assets/images/avatar/avatar-11.jpg' }}" alt="avatar">
                </div>
                <div>
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    Samantha Shelton
            ...
            <div class="flex cursor-pointer items-center justify-between">
              <div class="flex items-center space-x-3.5">
                <div class="avatar">
                  <img class="rounded-full" src="{{ 'assets/images/avatar/avatar-19.jpg' }}" alt="avatar">
                </div>
                <div>
                  <p class="font-medium text-slate-700 dark:text-navy-100">
                    Joe Perkins
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-1 lg:gap-6">
        <div class="card px-4 pb-4 sm:px-5">
          ...
          <div class="space-y-4">
            <div class="flex cursor-pointer items-center justify-between space-x-2">
              ...
              <a href="#" class="hover:text-primary focus:text-primary dark:hover:text-accent-light dark:focus:text-accent-light">
        ...
        <div class="card">
          ...
          <div class="ax-transparent-gridline pr-2">
            <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.incomePersonal); $el._x_chart.render() });"></div>
          </div>
        </div>
        <div class="card p-4">
            ...
            <div class="swiper" x-init="$nextTick(()=>$el._x_swiper = new Swiper($el,{pagination: {el: '.swiper-pagination',clickable: true}}))">
              <div class="swiper-wrapper">
                <div class="swiper-slide p-4 sm:p-5">
                  <div class="flex items-center justify-between">
                    <a href="#" class="font-inter font-medium tracking-wide transition-colors hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100">
                      @twitteraccount
                    </a>
                  ...
                  <div class="mt-2 pb-5 text-xs">
                    <a href="#" class="text-xs+ text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">#PHP  </a>
                    <a href="#" class="text-xs+ text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">#ReactJS  </a>
                    <a href="#" class="text-xs+ text-primary hover:text-primary-focus dark:text-accent-light dark:hover:text-accent">#NextJS  </a>
                  </div>
                </div>
                <div class="swiper-slide p-4 sm:p-5">
                  <div class="flex items-center justify-between">
